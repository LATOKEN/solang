...
fn pure_function() {
    ...
    assert!(ns
        .diagnostics
        .contains_message("builtin 'log0' is not available for target lachain. Please, open a GitHub issue at https://github.com/hyperledger-labs/solang/issues if there is need to support this function"));
}
...
fn view_function() {
    ...
    assert!(ns
        .diagnostics
        .contains_message("builtin 'create' is not available for target lachain. Please, open a GitHub issue at https://github.com/hyperledger-labs/solang/issues if there is need to support this function"));
